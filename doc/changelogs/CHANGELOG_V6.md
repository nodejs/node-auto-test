...
* [[`72f2646622`](https://github.com/nodejs/node/commit/72f2646622)] - **build**: use generic names for linting tasks (Nikolai Vavilov) [#15272](https://github.com/nodejs/node/pull/15272)
...
* [[`5cf6f16cdd`](https://github.com/nodejs/node/commit/5cf6f16cdd)] - **doc**: add callback function signatures in fs.md (Matej Krajčovič) [#13424](https://github.com/nodejs/node/pull/13424)
* [[`1a8b1cfb2a`](https://github.com/nodejs/node/commit/1a8b1cfb2a)] - **doc**: fix external links with 404 status (Vse Mozhet Byt) [#15463](https://github.com/nodejs/node/pull/15463)
* [[`8246306935`](https://github.com/nodejs/node/commit/8246306935)] - **doc**: add kfarnung to collaborators (Kyle Farnung) [#16108](https://github.com/nodejs/node/pull/16108)
* [[`e54da99a61`](https://github.com/nodejs/node/commit/e54da99a61)] - **doc**: mention collaboration summit in onboarding.md (Joyee Cheung) [#16079](https://github.com/nodejs/node/pull/16079)
* [[`478647e56b`](https://github.com/nodejs/node/commit/478647e56b)] - **doc**: fix macosx-firewall suggestion BUILDING (suraiyah) [#15829](https://github.com/nodejs/node/pull/15829)
* [[`ecfddf194a`](https://github.com/nodejs/node/commit/ecfddf194a)] - **doc**: add clearer setup description (Emily Platzer) [#15962](https://github.com/nodejs/node/pull/15962)
* [[`1acf1425b7`](https://github.com/nodejs/node/commit/1acf1425b7)] - **doc**: update style guide for markdown extension (Rich Trott) [#15786](https://github.com/nodejs/node/pull/15786)
* [[`24a6f6c145`](https://github.com/nodejs/node/commit/24a6f6c145)] - **doc**: fix incorrect vm.createContext usage (tshemsedinov) [#16059](https://github.com/nodejs/node/pull/16059)
...
* [[`d01978e1c0`](https://github.com/nodejs/node/commit/d01978e1c0)] - **src**: replace manual memory mgmt with std::string (Ben Noordhuis) [#15782](https://github.com/nodejs/node/pull/15782)
* [[`24e74f73b6`](https://github.com/nodejs/node/commit/24e74f73b6)] - **src**: fix ^ in stack trace with vm's columnOffset (Timothy Gu) [#15771](https://github.com/nodejs/node/pull/15771)
...
* [[`f65f691624`](https://github.com/nodejs/node/commit/f65f691624)] - **test**: move test-cluster-debug-port to sequential (Oleksandr Kushchak) [#16292](https://github.com/nodejs/node/pull/16292)
* [[`db37c88170`](https://github.com/nodejs/node/commit/db37c88170)] - **test**: begin normalizing fixtures use (James M Snell) [#14332](https://github.com/nodejs/node/pull/14332)
* [[`2ddd9cb07f`](https://github.com/nodejs/node/commit/2ddd9cb07f)] - **test**: remove assert message (Joe Henry) 
* [[`0c0243a0ac`](https://github.com/nodejs/node/commit/0c0243a0ac)] - **test**: clarify assert messages in crypto tests (cpandrews8) [#16019](https://github.com/nodejs/node/pull/16019)
* [[`5d21f008ae`](https://github.com/nodejs/node/commit/5d21f008ae)] - **test**: include expected result in error messages (Chowdhurian) [#16039](https://github.com/nodejs/node/pull/16039)
* [[`353476d287`](https://github.com/nodejs/node/commit/353476d287)] - **test**: cleanup test-buffer-sharedarraybuffer (Rafal Leszczynski) [#15896](https://github.com/nodejs/node/pull/15896)
* [[`35a97fa989`](https://github.com/nodejs/node/commit/35a97fa989)] - **test**: updated error message (Emily Platzer) [#15906](https://github.com/nodejs/node/pull/15906)
* [[`fe07a586d2`](https://github.com/nodejs/node/commit/fe07a586d2)] - **test**: assert.strictEqual using template literals (jmcgui05) [#15944](https://github.com/nodejs/node/pull/15944)
* [[`7c4351e33d`](https://github.com/nodejs/node/commit/7c4351e33d)] - **test**: replace error msg w/ template literal (Sushil Tailor) [#15910](https://github.com/nodejs/node/pull/15910)
* [[`199113cb78`](https://github.com/nodejs/node/commit/199113cb78)] - **test**: add NODE_UNIQUE_ID value to err message (Daniele Lisi) [#15914](https://github.com/nodejs/node/pull/15914)
* [[`1aac70feeb`](https://github.com/nodejs/node/commit/1aac70feeb)] - **test**: replace string concatenation with template (Rob Paton) [#15915](https://github.com/nodejs/node/pull/15915)
* [[`94069168be`](https://github.com/nodejs/node/commit/94069168be)] - **test**: improve asset msg in test (Gene Wu) [#15918](https://github.com/nodejs/node/pull/15918)
* [[`c7b3bd0d0d`](https://github.com/nodejs/node/commit/c7b3bd0d0d)] - **test**: remove message from asserts (Justin Lee) [#15920](https://github.com/nodejs/node/pull/15920)
* [[`6e968298a7`](https://github.com/nodejs/node/commit/6e968298a7)] - **test**: improve an error message (Pavel Pomerantsev) [#15921](https://github.com/nodejs/node/pull/15921)
* [[`c86643cd7c`](https://github.com/nodejs/node/commit/c86643cd7c)] - **test**: replaced literals in errors with templates (Paul Milham) [#15911](https://github.com/nodejs/node/pull/15911)
* [[`1eeed4fa77`](https://github.com/nodejs/node/commit/1eeed4fa77)] - **test**: display better error message for assertion (Russell Dempsey) [#15883](https://github.com/nodejs/node/pull/15883)
* [[`5544bd4e20`](https://github.com/nodejs/node/commit/5544bd4e20)] - **test**: changed buffer-zero output (heeeunkimmm) [#15926](https://github.com/nodejs/node/pull/15926)
* [[`cf375a649f`](https://github.com/nodejs/node/commit/cf375a649f)] - **test**: remove literal error messages (Faisal Yaqoob) [#15928](https://github.com/nodejs/node/pull/15928)
* [[`1b3096aeda`](https://github.com/nodejs/node/commit/1b3096aeda)] - **test**: changes to use template literal (joanne-jjb) [#15937](https://github.com/nodejs/node/pull/15937)
* [[`b162216fa7`](https://github.com/nodejs/node/commit/b162216fa7)] - **test**: removed string from assert message arg (dpaulino) [#15954](https://github.com/nodejs/node/pull/15954)
* [[`bec173ded4`](https://github.com/nodejs/node/commit/bec173ded4)] - **test**: replace literal with template string (Brant Barger) [#15957](https://github.com/nodejs/node/pull/15957)
* [[`ef7c16d9c0`](https://github.com/nodejs/node/commit/ef7c16d9c0)] - **test**: improve assert messages (Eric Pemberton) [#15972](https://github.com/nodejs/node/pull/15972)
* [[`dd130f4179`](https://github.com/nodejs/node/commit/dd130f4179)] - **test**: replacing assert message with template (Barry Tam) [#15974](https://github.com/nodejs/node/pull/15974)
* [[`ee610c1979`](https://github.com/nodejs/node/commit/ee610c1979)] - **test**: alter assert.strictEqual to default message (Luke Greenleaf) [#15978](https://github.com/nodejs/node/pull/15978)
* [[`c308a30535`](https://github.com/nodejs/node/commit/c308a30535)] - **test**: remove messages in assert.strictEqual (Saeed H) [#16014](https://github.com/nodejs/node/pull/16014)
...
* [[`a15f33ce94`](https://github.com/nodejs/node/commit/a15f33ce94)] - **tools**: replace concatenation with string templates (Ethan Arrowood) [#15858](https://github.com/nodejs/node/pull/15858)
* [[`e27eb6350f`](https://github.com/nodejs/node/commit/e27eb6350f)] - **tools**: replace concat with template literals (Minya Liang) [#16046](https://github.com/nodejs/node/pull/16046)
* [[`2fefc17ee5`](https://github.com/nodejs/node/commit/2fefc17ee5)] - **tools**: use template literals (Sarah Meyer) [#15956](https://github.com/nodejs/node/pull/15956)
...
* [[`1d94a86e7f`](https://github.com/nodejs/node/commit/1d94a86e7f)] - **tty**: require readline at top of file (Bryan English) [#15647](https://github.com/nodejs/node/pull/15647)
